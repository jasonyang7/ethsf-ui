            ...
            <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
              <table className="min-w-full divide-y divide-gray-300">
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {loans.map((loan) => (
                    <tr key={loan.borrowerAddress + loan.collateralTokenAddress}>
                      <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                        {/* <div className="flex items-center"> */}
                          ...
                          <div className="ml-4">
                            <div className="font-medium text-gray-900">{loan.collateralToken}</div>
                          </div>
                        {/* </div> */}
                      </td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        <div className="text-gray-900">{loan.collateralAmount}</div>
                        {/* <div className="text-gray-500">{person.department}</div> */}
                      </td>
                      
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{loan.amtUSDCToBorrow}</td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{loan.loanDuration}</td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
